...
namespace Allexgro.Migrations
{
    ...
    [Migration("20250622222825_23_06_2025_00_28")]
    partial class _23_06_2025_00_28
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StripeUserAccountDetails", b =>
                {
                    b.Property<string>("userId")
                        .HasColumnType("text");

                    b.Property<DateTime>("OnboardingAccountLinkExpiration")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("OnboardingAccountLinkUrl")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime?>("UpdateAccountLinkExpiration")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("UpdateAccountLinkUrl")
                        .HasColumnType("text");
                    ...
                    b.ToTable("StripeUserAccountDetails");
                });
            ...
            modelBuilder.Entity("StripeUserAccountDetails", b =>
                {
                    b.HasOne("User", "User")
                        .WithOne("stripeUserAccountDetails")
                        .HasForeignKey("StripeUserAccountDetails", "userId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.Navigation("stripeUserAccountDetails")
                        .IsRequired();
                });
